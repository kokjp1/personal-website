  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm leading-6">
        This is the third version of my portfolio website, developed to show who I am, what I've made and what I'm good
        at. It's built using (modern) web technologies like React, TypeScript, Tailwind, Next.js and shadcn, ensuring a
